 ...
 * author: "oujizeng",
 * license: "MIT",
 * github: "https://github.com/yangyuji/pull-down-banner",
 * name: "pull-down-banner.js",
 * version: "1.0.0"
 */
...
(function (root, factory) {
    ...
    function pullDownBanner(opt) {
        this.moveCount = opt.moveCount || 75;               // 临界值
        ...
        this.wrapper = util._getEle(opt.dragger);          // 拖动区域
        this.banner = util._getEle(opt.banner);
    ...
    pullDownBanner.prototype = {
        ...
        _move: function (e) {
            ...
            this.translateY = moveY > this.bannerHeight ? this.bannerHeight * 0.5 : moveY * 0.5;
            ...
            if (document.documentElement.scrollTop + document.body.scrollTop === 0) {
                if (this.translateY > 0) {
                    ...
                    this.text.style.opacity = Math.abs(this.translateY) >= this.moveCount ? 1 : Math.abs(this.translateY) / this.moveCount;

                    util._translate(this.wrapper, 'Transform', 'translate3d(0,' + this.translateY + 'px,0)');
                    util._translate(this.banner, 'Transform', 'translate3d(0,' + this.translateY + 'px,0)');
        ...
        _end: function (e) {
            ...
            if (this.translateY > this.moveCount && this.joinRefreshFlag) {
                ...
                util._translate(this.banner, 'Transform', 'translate3d(0, '+ this.moveCount +'px,0)');
